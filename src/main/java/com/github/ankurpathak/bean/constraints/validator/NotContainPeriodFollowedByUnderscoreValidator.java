...
import com.github.ankurpathak.bean.constraints.NotContainPeriodFollowedByUnderscore;
...
public class NotContainPeriodFollowedByUnderscoreValidator implements ConstraintValidator<NotContainPeriodFollowedByUnderscore, String> {
    ...
    public boolean isValid(String username, ConstraintValidatorContext constraintValidatorContext) {
        return UsernameValidator.notContainPeriodFollowedByUnderscore(username, config.leaveBlank());
    }
