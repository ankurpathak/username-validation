...
import com.github.ankurpathak.bean.constraints.NotContainConsecutiveUnderscore;
...
public class NotContainConsecutiveUnderscoreValidator implements ConstraintValidator<NotContainConsecutiveUnderscore, String> {
    ...
    public boolean isValid(String username, ConstraintValidatorContext constraintValidatorContext) {
        return UsernameValidator.notContainConsecutiveUnderscore(username, config.leaveBlank());
    }
}
